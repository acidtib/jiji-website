...
The config above runs 3 instances on app1, 3 on app2, and 3 on app3 (9
total), not 3 total. Change the replicated runtime desired count without
...
A `stop_first` service must remain a singleton - `scale` above 1 is
