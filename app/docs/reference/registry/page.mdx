...
```
Remote Builder (127.0.0.1:<registry.port>)
        |
        | SSH reverse tunnel used for build and push
        v
Local Machine (127.0.0.1:<registry.port>)
        |
        | separate SSH reverse tunnel used for pull
        v
Deployment Server (127.0.0.1:<registry.port>)
```
